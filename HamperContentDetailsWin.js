/*
 * File: app/view/HamperContentDetailsWin.js
 *
...
Ext.define('Cobuy.view.HamperContentDetailsWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.hampercontentdetailswin',

    requires: [
        'Cobuy.view.HamperProductContentsForm',
        'Ext.form.Panel',
        'Ext.toolbar.Toolbar',
        'Ext.button.Button',
        'Ext.toolbar.Fill',
    ...
    height: 650,
    id: 'hampercontentdetailswin',
    width: 1200,
    layout: 'fit',
    title: 'Hamper Product Details ',
    modal: true,
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    xtype: 'hamperproductcontentsform'
                }
            ],
            dockedItems: [
                {
